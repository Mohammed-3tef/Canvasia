...
{
    public partial class SkewFilterPage : Form
    {
        public SkewFilterPage()
        {
            InitializeComponent();
        ...
        private void applyFilterBtn_Click(object sender, EventArgs e)
        {
            ...
            PhotoManager.ApplyFilter(pictureBox1, pictureBox2, original =>
                Filters.SkewImage(original, (int)addDegreeOfSkewness.Value)
            );
